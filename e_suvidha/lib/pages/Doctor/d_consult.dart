...
class DConsult extends StatefulWidget {
  const DConsult({Key? key}) : super(key: key);

  @override
  State<DConsult> createState() => _DConsultState();
}

class _DConsultState extends State<DConsult> {
              ...
              child: Container(
                ...
                child: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('docid', isEqualTo: doctor.uid)
                      .snapshots(),
  ...
  Widget demoTopRatedDr(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, '/p_detail', arguments: {
          'docname': docname,
          'docdegree': docdegree,
