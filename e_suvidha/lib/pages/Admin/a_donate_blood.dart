...
class AdminDonateBlood extends StatefulWidget {
  const AdminDonateBlood({Key? key}) : super(key: key);

  @override
  State<AdminDonateBlood> createState() => _AdminDonateBloodState();
}

class _AdminDonateBloodState extends State<AdminDonateBlood> {
  @override
  ...
  Widget demoTopRatedDr(
    ...
    return GestureDetector(
      onTap: () async {
        Navigator.pushNamed(context, '/a_donate_detail', arguments: {
          'address': address,
          'age': age,
          'alcohol': alcohol,
