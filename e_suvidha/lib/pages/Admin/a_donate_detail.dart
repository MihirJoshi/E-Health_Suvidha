...
class AdminDonateBloodDetail extends StatefulWidget {
  const AdminDonateBloodDetail({Key? key}) : super(key: key);

  @override
  State<AdminDonateBloodDetail> createState() => _AdminDonateBloodDetailState();
}

class _AdminDonateBloodDetailState extends State<AdminDonateBloodDetail> {
  @override
  Widget build(BuildContext context) {
    final args = ModalRoute.of(context)!.settings.arguments as Map;
    var address = args['address'];
    var age = args['age'];
    var alcohol = args['alcohol'];
    ...
    var hiv = args['hiv'];
    var immune = args['immune'];
    var last_donate = args['last_donate'];
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text("Blood Donate History",
                              style: TextStyle(
                                  fontSize: 18.0,
                                  color: Colors.black,
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(
                                      "Last Donation: $last_donate in Months",
                                      style: TextStyle(
                                          color: Color(0xff363636),
                                          fontSize: 16,
                                          fontFamily: 'Roboto',
