...
class ShowAssignTech extends StatefulWidget {
  const ShowAssignTech({Key? key}) : super(key: key);

  @override
  State<ShowAssignTech> createState() => _ShowAssignTechState();
}

class _ShowAssignTechState extends State<ShowAssignTech> {
  @override
  Widget build(BuildContext context) {
    final args = ModalRoute.of(context)!.settings.arguments as Map;
    var docVal = args['docVal'];
    var techGlobal = args['techGlobal'];
    var p_t_name = docVal['p_name'];
    var p_t_age = docVal['p_age'];
    var p_t_id = docVal['patient_id'];
    var p_t_mobno = docVal['p_mobno'];
    var p_t_email = docVal['p_email'];
    var p_t_gender = docVal['p_gender'];
    var p_t_issue = docVal['p_issue'];
    var p_t_symp = docVal['p_symp'];
    var p_t_lab_type = docVal['lab_type'];
    var p_t_time = docVal['p_time'];
    var p_t_date = docVal['p_date'];
    var t_name = techGlobal['t_name'];
    var t_age = techGlobal['t_age'];
    var t_mobno = techGlobal['t_mobno'];
    var t_email = techGlobal['t_email'];
    var t_degree = techGlobal['t_degree'];
    var t_gender = techGlobal['t_gender'];
    print(p_t_name);
