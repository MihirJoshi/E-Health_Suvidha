...
class AdminApplyBlood extends StatefulWidget {
  const AdminApplyBlood({Key? key}) : super(key: key);

  @override
  State<AdminApplyBlood> createState() => _AdminApplyBloodState();
}

class _AdminApplyBloodState extends State<AdminApplyBlood> {
  @override
  ...
  Widget demoTopRatedDr(
    ...
    return GestureDetector(
      onTap: () async {
        Navigator.pushNamed(context, '/a_apply_detail', arguments: {
          'address': address,
          'age': age,
