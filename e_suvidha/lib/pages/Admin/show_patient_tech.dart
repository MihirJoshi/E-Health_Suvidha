...
class ShowPatientTech extends StatefulWidget {
  const ShowPatientTech({Key? key}) : super(key: key);

  @override
  State<ShowPatientTech> createState() => _ShowPatientTechState();
}

class _ShowPatientTechState extends State<ShowPatientTech> {
  @override
  Widget build(BuildContext context) {
    ...
    var p_t_lab_type = args['p_lab_type'];
