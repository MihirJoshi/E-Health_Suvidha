...
class ApplyBloodDetail extends StatefulWidget {
  const ApplyBloodDetail({Key? key}) : super(key: key);

  @override
  State<ApplyBloodDetail> createState() => _ApplyBloodDetailState();
}

class _ApplyBloodDetailState extends State<ApplyBloodDetail> {
  @override
