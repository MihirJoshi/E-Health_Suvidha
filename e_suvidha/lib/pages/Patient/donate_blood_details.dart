...
class DonateBloodDetail extends StatefulWidget {
  const DonateBloodDetail({Key? key}) : super(key: key);

  @override
  State<DonateBloodDetail> createState() => _DonateBloodDetailState();
}

class _DonateBloodDetailState extends State<DonateBloodDetail> {
  @override
