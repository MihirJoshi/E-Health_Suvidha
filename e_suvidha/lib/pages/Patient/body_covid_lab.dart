...
class CovidLab extends StatefulWidget {
  const CovidLab({Key? key}) : super(key: key);

  @override
  State<CovidLab> createState() => _CovidLabState();
}

class _CovidLabState extends State<CovidLab> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 1,
        title: Text("Full Body Checkup With Covid Tests"),
      ),
            ...
            child: ListView(
              ...
              children: [
                demoTopRatedDr("assets/images/drawer_logo.png",
                    "Full Body Checkup With Covid", "Covers 81 Tests", "₹1299"),
              ],
            ),
          ),
            ...
            child: InkWell(
              ...
              onTap: () {
                Navigator.pushNamed(context, '/book_lab_form', arguments: {
                  'lab_name': "Full Body Checkup With Covid",
                });
              },
              child: Container(
                width: 300.0,
