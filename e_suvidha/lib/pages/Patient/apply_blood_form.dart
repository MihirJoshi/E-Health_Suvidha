...
class ApplyBlood extends StatefulWidget {
  const ApplyBlood({Key? key}) : super(key: key);

  @override
  State<ApplyBlood> createState() => _ApplyBloodState();
}
...
List<String> bloodItem = [
  "Emergency",
  "Urgent (Within 1 hour)",
  "Standard (Within 12 hour)",
  "Group (within 7 Days)"
];
String? requestChoose = "Emergency";

List<String> groupItem = ["A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"];
String? groupChoose = "A+";

class _ApplyBloodState extends State<ApplyBlood> {
  ...
  TextEditingController _docMobnoController = TextEditingController();
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          decoration: ThemeHelper()
                              .textInputDecoration('Request', 'Choose Request'),
                          value: requestChoose,
                          items: bloodItem
                              .map((item) => DropdownMenuItem<String>(
                                    value: item,
                        ...
                        Container(
                          child: TextFormField(
                            ...
                            autovalidateMode: AutovalidateMode.always,
                            validator: CheckMobno,
                            controller: _docMobnoController,
                            autofocus: false,
                            textInputAction: TextInputAction.next,
                          ),
                          decoration: ThemeHelper().inputBoxDecorationShaddow(),
                        ...
                        AuthButton(
                          onTap: () {
                            _firestore.collection('apply_blood').add({
                              ...
                              'request': requestChoose,
                              'date': _dateController.text,
                              'time': _timeController.text,
                              'doc_name': _docNameController.text,
                              'doc_mobno': _docMobnoController.text,
                              'blood_unit': _unitController.text,
